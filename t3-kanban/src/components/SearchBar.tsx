      ...
      >
        <Dialog as="div" className="relative z-10" onClose={setOpen}>
          ...
          <div className="fixed inset-0 z-10 w-screen overflow-y-auto p-4 sm:p-6 md:p-20">
            ...
            >
              <Dialog.Panel className="ring- mx-auto max-w-xl transform divide-y divide-gray-100 overflow-hidden rounded-xl bg-white shadow-2xl ring-1 ring-opacity-5 transition-all">
